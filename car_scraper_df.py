...
if response.status_code == 200:
    ...
    # Initialize an empty list to store car data (need and empty list to store for the creation of the Data Frame)
    car_data = []
    ...
    df_cars.to_csv("./fixtures/classic_cars_listings.csv", index=False)

    print("Car data has been successfully saved to 'classic_cars_listings.csv'")
else:
...
"Title not found", "Description not found", or "Price not available".
